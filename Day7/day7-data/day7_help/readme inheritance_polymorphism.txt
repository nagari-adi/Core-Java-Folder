...
Abstract classes can't be instantiated BUT can create the ref. of abstract class type to refer to concrete(non abstract) sub-class instances.
eg : suppose Emp is abstract n Mgr is concrete
...
Mgr extends Emp : to init empId, dept ... : MUST supply a constr in abstract Emp class.
